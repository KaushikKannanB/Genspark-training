...
namespace FirstAPI.Services
{
    public class DoctorService : IDoctorService
    {
        ...
        public DoctorService(IRepository<int, Doctor> doctorRepository,
                            ...
                            IMapper mapper, ClinicContext c)
        {
        ...
        {
            var doc = await clinicContext.Doctors.FirstOrDefaultAsync(d => d.Name == name);
            return doc;
        }
        public async Task<Doctor> GetDoctByMail(string name)
        {
            var doc = await clinicContext.Doctors.FirstOrDefaultAsync(d => d.Email == name);
            return doc;
        }
