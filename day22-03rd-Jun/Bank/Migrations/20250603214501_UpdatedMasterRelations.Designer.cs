...
namespace Bank.Migrations
{
    ...
    [Migration("20250603214501_UpdatedMasterRelations")]
    partial class UpdatedMasterRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bank.Models.Admin", b =>
                {
                    b.HasOne("Bank.Models.Master", "Master")
                        .WithOne("Admin")
                        .HasForeignKey("Bank.Models.Admin", "Name")
            ...
            modelBuilder.Entity("Bank.Models.User", b =>
                {
                    b.HasOne("Bank.Models.Master", "Master")
                        .WithOne("User")
                        .HasForeignKey("Bank.Models.User", "Name")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
