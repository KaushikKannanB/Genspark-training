    ...
    public class BankContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(u => u.Master).WithOne(m=>m.User).HasForeignKey<User>(u=>u.Email).HasConstraintName("FK_User_Master");
            ...
            modelBuilder.Entity<Admin>(entity =>
            {
                ...
                entity.HasOne(a => a.Master).WithOne(m => m.Admin).HasForeignKey<Admin>(m => m.Email).HasConstraintName("FK_Admin_Master");
            });
