    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Twwets_hashtags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Twwets_hashtags_HashTags_HashTagId",
                        column: x => x.HashTagId,
                        principalTable: "HashTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Twwets_hashtags_Tweets_TweetId",
                        column: x => x.TweetId,
                        principalTable: "Tweets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Twwets_hashtags_HashTagId",
                table: "Twwets_hashtags",
                column: "HashTagId");

            migrationBuilder.CreateIndex(
                name: "IX_Twwets_hashtags_TweetId",
                table: "Twwets_hashtags",
                column: "TweetId");
        }
